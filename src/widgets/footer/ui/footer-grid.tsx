...
export function FooterGrid() {
  return (
    <section className="bg-gray-50">
      <div className="mx-auto grid w-full max-w-330 grid-cols-3 gap-8 px-5 py-10 lg:grid-cols-[2fr_repeat(3,1fr)_3fr] lg:px-15 lg:py-15">
        <div className="col-span-3 flex flex-col items-center text-center sm:items-start sm:text-left sm:col-span-1">
          ...
          <address className="mt-4 flex flex-ro not-italic items-center justify-center gap-3 text-sm lg:justify-start">
            <a
        ...
        {footerColumns.map((column) => (
          <div key={column.title} className="col-span-1 flex flex-col items-center">
